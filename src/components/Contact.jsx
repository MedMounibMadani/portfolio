...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen flex flex-col items-center justify-around bg-gray-900 text-white px-6 py-16"
    >
      ...
      <div className="flex flex-col items-center justify-center gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="mailto:madani.mounib@gmail.com">madani.mounib@gmail.com</a>
        </div>
        <div className="flex items-center gap-3">
